    ...
    self.search_marker()
        ...
        if(self.detected==0 and self.search_change==1): 
            ...
            if(self.reached==1 and self.wait==0): 
                ...
                alti=self.setpoints[self.search_index][2]-(16.75-0.35)+0.4
...
if __name__ == '__main__':  
   ...
   Called at the start of executing the script
    ...
    with open("/home/ashish/catkin_ws/src/vitarana_drone/scripts/original.csv","r") as csv_file:
...
##############################################################################################################################     
        ...
        e_drone.setpoints.append([nearest_parcel_lst[index_i][0],nearest_parcel_lst[index_i][1],nearest_parcel_lst[index_i][2]+5,nearest_parcel_lst[index_i][3],nearest_parcel_lst[index_i][4]]) # To hover 5 metres above closest return parcel
